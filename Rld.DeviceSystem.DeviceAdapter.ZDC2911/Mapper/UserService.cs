    ...
    public class UserService
    {
        ...
        public UserInfo GetUserInfo(int userId)
        {
            try
            {
                ...
                var userInfo = new UserInfo() { UserId = userId };
        ...
        public bool ModifyUserInfo(UserInfo userInfo)
        {
            var device = _deviceProxy.Device;
        ...
        public void GetUserName(ref UserInfo DeviceUser)
        {
        ...
        public void GetPassword(ref UserInfo DeviceUser)
        {
            object extraData = new object();
        ...
        public void GetCard(ref UserInfo DeviceUser)
        {
            object extraData = new object();
            Enroll enroll = new Enroll() { DIN = (UInt64)DeviceUser.UserId };
            User user = new User() { DIN = (UInt64)DeviceUser.UserId, Enrolls = new List<Enroll> { enroll } };
        ...
        public void GetFingerPrint(ref UserInfo DeviceUser, Int32 index)
        {
            try
            {
                var device = _deviceProxy.Device;
        ...
        public UserEnrollSummary GetUserEnrollSummary(Int32 userID)
        {
            ...
            dto.Role = (UserRole)rawUser.Privilege;
