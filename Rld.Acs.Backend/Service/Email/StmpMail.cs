...
namespace StmpMailTest
{
    ...
    {
        /// <summary>
        /// 发送HTML格式邮件，带抄送、密送以及附件
        /// </summary>
        public static string MailTo(SmtpConfig config,MailAddress AddrFrom, MailAddress AddrTo,MailAddressCollection cc, MailAddressCollection bCC,string Subject, string BodyContent, bool isHtml, List<Attachment> attC)
        {
        ...
        /// <returns></returns>
        public static string MailTo(SmtpConfig config,MailAddress AddrFrom, MailAddress AddrTo,string Subject, string BodyContent)
        {
